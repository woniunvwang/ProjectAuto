...
class StopOrderPage(BasePage):
    ...
    def order_details_stop_price_value(self):
        order_details_stop_price_value = self.get_visible_element(all_path.order_details_stop_price).text
        return order_details_stop_price_value

    def order_details_stop_option_value(self):
        order_details_stop_option_value = self.get_visible_element(all_path.order_details_stop_option).text
    ...
    def press_bid(self):
        ...
        self.click_action(all_path.stop_order_path)
    ...
    def press_bid_and_check_stop_price(self):
        offer_value = self.get_visible_element(all_path.offer_price_path).text
        self.press_bid()
        stop_price_value = self.get_visible_element(all_path.stop_price_xpath).text
        self.press_confirm_button()
    ...
    def press_offer_and_check_stop_price(self):
        bid_value = self.get_visible_element(all_path.bid_price_path).text
        self.press_offer()
        stop_price_value = self.get_visible_element(all_path.stop_price_xpath).text
        self.slide_action(460, 1750, 460, 1400)
        self.press_confirm_button()
    ...
    def clear_stop_price_and_order(self):
        self.press_offer()
        self.clear_action(all_path.stop_price_xpath)
        self.press_confirm_button()
    ...
    def input_illegal_stop_price_and_order(self, price):
        self.press_offer()
        self.clear_action(all_path.stop_price_xpath)
        self.input_action(all_path.stop_price_xpath, price)
        self.press_confirm_button()
        self.press_confirm_button()
    ...
    def stop_option_last_trade_price_and_order(self):
        self.press_offer()
        stop_option_default_value = self.get_visible_element(all_path.stop_price_type_ID).text
        self.slide_action(460, 1750, 460, 1400)
        self.press_confirm_button()
    ...
    def stop_option_market_buy_price_and_order(self):
        self.press_offer()
        self.click_action(all_path.stop_price_type_ID)
        self.click_action(all_path.stop_price_option_market_buy_price)
        self.press_confirm_button()
        stop_option_value = self.get_visible_element(all_path.stop_price_type_ID).text
        self.slide_action(460, 1750, 460, 1400)
        self.press_confirm_button()
        order_details_stop_option_value = self.order_details_stop_option_value()
        self.press_confirm_button()
    ...
    def stop_option_market_sell_price_and_order(self):
        self.press_offer()
        self.click_action(all_path.stop_price_type_ID)
        self.click_action(all_path.stop_price_option_market_sell_price)
        self.press_confirm_button()
        stop_option_value = self.get_visible_element(all_path.stop_price_type_ID).text
        self.slide_action(460, 1750, 460, 1400)
        self.press_confirm_button()
