...
class NormalOrderPage(BasePage):
    ...
    order_details_price = (AppiumBy.XPATH,
                           "//*[@resource-id='com.atp.newdemo2:id/content_root']/child::android.view.ViewGroup["
    ...
    order_details_memo = (AppiumBy.XPATH, "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout/android.view.ViewGroup[11]/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.TextView")
    # order_details_memo1 = (AppiumBy.XPATH,
    #                       "//*[text()='备注']//following-sibling::android.widget.RelativeLayout//*[@class=,"android.widget.TextView"]")
    # 找到合约组"自动化测试合约"，
    ...
    def login_successful(self):
        ...
        self.slide_action(960, 325, 700, 318)
