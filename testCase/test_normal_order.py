import os
from common.basePage import LocalizedTool
import pytest
...
class TestCaseNormalOrder:
    ...
    def test_04_press_offer_and_side_should_sell(self):
        ...
        assert (order_details_side_value == LocalizedTool.getLocalizedString("order_direction_buy"))
    ...
    def test_18_clear_lots_and_order_should_fail(self):
        ...
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_message_lots"))
        assert result

    def test_19_input_illegal_lots_and_order_should_fail(self):
        self.normal_order_page.input_illegal_lots_and_order("1.")
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_illegal_lots"))
        assert result

    def test_20_clear_price_and_order_should_fail(self):
        self.normal_order_page.clear_price_and_order()
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_message_price"))
        assert result

    def test_21_input_illegal_price_and_order_should_fail(self):
        self.normal_order_page.input_illegal_price_and_order(".")
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_illegal_price"))
        assert result
    ...
    def test_24_input_illegal_price_tick_size_and_order_should_fail(self):
        ...
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_illegal_price_tick_size"))
        assert result
    ...
    def test_34_stp_type_clear_StPx_and_order_should_fail(self):
        ...
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_message_StPx"))
        assert result
    ...
    def test_36_stp_type_and_buy_side_and_input_StPx_below_last_price_should_fail(self):
        ...
        assert (LocalizedTool.getLocalizedString("alert_message_buy_order_rejected") == result)
    ...
    def test_37_stp_type_and_sell_side_and_input_StPx_above_last_price_should_fail(self):
        ...
        result = self.normal_order_page.alert_order_details_message()
        assert (LocalizedTool.getLocalizedString("alert_message_sell_order_rejected") == result)
    ...
    def test_47_stl_type_and_buy_side_and_above_last_price_and_StPx_above_price_should_fail(self):
        ...
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_buy_order_illegal_StPx"))
        assert result
    ...
    def test_48_stl_type_and_sell_side_and_above_last_price_and_StPx_below_price_should_fail(self):
        ...
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_sell_order_illegal_StPx"))
        assert result
    ...
    def test_56_ice_type_and_clear_chunk_size_and_order_should_fail(self):
        ...
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_message_chunk_size"))
        assert result
    ...
    def test_57_TIF_DAY_order_should_success(self):
        ...
        result = self.normal_order_page.alert_order_details_message()
        assert (result == LocalizedTool.getLocalizedString("alert_order_message"))
    ...
    def test_62_tif_fak_and_clear_min_quantity_and_order_should_fail(self):
        ...
        result = self.normal_order_page.is_toast_exist(LocalizedTool.getLocalizedString("alert_message_min_quantity"))
        assert result
    ...
    def test_70_offset_flag_auto_and_order_should_success(self):
        ...
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_default_value == LocalizedTool.getLocalizedString("offset_flag_auto"))
    ...
    def test_71_offset_flag_open_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("offset_flag_open"))
    ...
    def test_72_offset_flag_close_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("close"))
        assert (offset_flag_value == order_details_offset_flag_value)
    ...
    def test_73_offset_flag_closeYesterday_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("cy_o"))
        assert (offset_flag_value == order_details_offset_flag_value)
    ...
    def test_74_offset_flag_closeToday_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("closeToday"))
        assert (offset_flag_value == order_details_offset_flag_value)
    ...
    def test_75_offset_flag_C_CT_O_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("c_ct_o"))
        assert (offset_flag_value == order_details_offset_flag_value)
    ...
    def test_76_offset_flag_CT_C_O_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("ct_c_o"))
        assert (offset_flag_value == order_details_offset_flag_value)
    ...
    def test_77_offset_flag_C_O_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("c_o"))
        assert (offset_flag_value == order_details_offset_flag_value)
    ...
    def test_78_offset_flag_CT_O_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (offset_flag_value == LocalizedTool.getLocalizedString("ct_o"))
        assert (offset_flag_value == order_details_offset_flag_value)
    ...
    def test_80_hedge_flag_speculation_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (hedge_flag_default_value == LocalizedTool.getLocalizedString("speculation"))
    ...
    def test_81_hedge_flag_arbitrage_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (hedge_flag_value == LocalizedTool.getLocalizedString("arbitrage"))
    ...
    def test_82_hedge_flag_hedge_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_title()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (hedge_flag_value == LocalizedTool.getLocalizedString("hedge"))
        assert (hedge_flag_value == order_details_hedge_flag_value)
    ...
    def test_84_edit_memo_and_order_should_success(self):
        ...
        order_message = self.normal_order_page.alert_order_details_message()
        assert (order_message == LocalizedTool.getLocalizedString("alert_order_message"))
        assert (hint == LocalizedTool.getLocalizedString("hint_message"))
        assert (memo_value == order_details_memo_value)


if __name__ == '__main__':
    pytest.main(['test_normal_order.py', '-v', '--alluredir', './result'])
